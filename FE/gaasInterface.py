...
def createAuthFile():
    ...
    if prov in [1, 2, 3, 4, 5]:
        ...
        authFile.write('id = im; type = InfrastructureManager; username = admin; password = admin' + os.linesep)
        authFile.write('id = vmrc; type = VMRC; host = ****; username = ****; password = ****' + os.linesep)
        authFile.close()
